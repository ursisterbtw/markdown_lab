...
try:
    from .markdown_lab_rs import OutputFormat as RustOutputFormat
...
def convert_html(html: str, base_url: str = "", output_format: OutputFormat = OutputFormat.MARKDOWN) -> str:
    """
