...
class ContentChunker:
    ...
    def create_chunks_from_markdown(self, markdown_content: str, source_url: str) -> List[Chunk]:
        """
        ...
        for section_heading, section_content in sections:
            ...
            if len(section_content) <= self.chunk_size:
                chunk_id = hashlib.md5(f"{source_url}:{section_heading}".encode()).hexdigest()
                chunk = Chunk(
                    id=chunk_id,
                ...
                words_per_chunk = self.chunk_size // 5  # Approximate words per character
                ...
                for i in range(0, len(words), words_per_chunk - overlap_words):
                    ...
                    chunk_id = hashlib.md5(f"{source_url}:{section_heading}:{i}".encode()).hexdigest()
    ...
    def save_chunks(self, chunks: List[Chunk], output_dir: str, output_format: str = "jsonl") -> None:
        """
